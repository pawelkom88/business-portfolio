...
export default function Faq() {
  return (
    <>
      {/* ====== FAQ Section Start */}
      <section className="relative z-20 overflow-hidden bg-background-clr pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
        <div className="container mx-auto">
          ...
          <div className="mx-auto flex min-h-screen max-w-screen-sm items-center justify-center">
            <div className="h-36 w-full rounded-md bg-gradient-to-r from-indigo-300 via-red-300 to-yellow-200 p-1">
              <div className="flex h-full w-full items-center justify-center bg-background-clr back">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2">
              <div className="single-faq mb-8 w-full rounded-lg border border-primary-clr bg-background-clr p-4 sm:p-8 lg:px-6 xl:px-8">
                ...
                <div x-show="openFaq1" className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    ...
                    research &amp; creation of your monthly content marketing strategy that we do
          ...
          <svg
            ...
            <defs>
              <linearGradient
                ...
                <stop stopColor="#dbfe52" stopOpacity="0.46" />
                <stop offset={1} stopColor="#fff" stopOpacity={0} />
                <stop offset={1} stopColor="#fff" stopOpacity="0.096144" />
              </linearGradient>
            </defs>
          </svg>
        </div>
